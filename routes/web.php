...
Route::post('/pendaftaran/tambah/simpan', [PendaftaranController::class, 'simpan_pendaftaran'])->name('pendaftaran.simpan');
...
Route::get('/pasien/cetakAll', [PasienController::class, 'cetakAll'])->name('pasien.cetakAll');
//End Pasien
...
Route::get('/obat/cetakAll', [ObatController::class, 'cetakAll'])->name('obat.cetakAll');
//End Obat
...
Route::get('/rm/cetakAll', [RMController::class, 'cetakAll'])->name('rm.cetakAll');
//End rm
