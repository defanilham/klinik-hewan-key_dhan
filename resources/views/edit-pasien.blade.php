    ...
    @foreach ($datas as $data)
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $data->id }}">
                        ...
                        <!-- Informasi Hewan -->
                <div class="form-group">
                    <input type="text" class="form-control" name="nama_hewan" placeholder="Nama Hewan"value="{{ $data->nama_hewan}}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="ras" placeholder="Ras Hewan"value="{{ $data->ras}}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="warna_bulu" placeholder="Warna Bulu Hewan"value="{{ $data->warna_bulu}}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="jenis_hewan" placeholder="Jenis Hewan"value="{{ $data->jenis_hewan}}">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="berat_badan" placeholder="berat badan"value="{{ $data->berat_badan}}">
                            ...
                            <div class="form-group">
                                <textarea class="form-control " name="diagnosa_awal" placeholder="diagnosa awal">{{ $data->diagnosa_awal}}</textarea>
                            </div>                                 
                        <div class="form-group row">
