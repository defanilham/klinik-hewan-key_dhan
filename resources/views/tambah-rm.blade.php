                    ...
                    <form class="user" action="">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control " name="Id_Pasien" value="{{str_pad($iden->id, 4, '0', STR_PAD_LEFT)  }}" readonly>
                      </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control " name="nama_hewan" value="{{$iden->nama_hewan}}" readonly>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="ras">Ras :</label>
                            <input type="text" class="form-control " name="ras"  value="{{$iden->ras}}" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label for="warna_bulu">Warna Bulu :</label>
                            <input type="text" class="form-control " name="warna_bulu"  value="{{$iden->warna_bulu}}" readonly>   
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="jenis_hewan">Jenis Hewan :</label>
                            <input type="text" class="form-control " name="jenis_hewan" value="{{$iden->jenis_hewan}}" readonly> 
                        </div>
                    <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control " name="berat_badan" value="{{$iden->berat_badan}}kg" readonly> 
                        </div>
                    <div class="col-sm-6">
                        <label for="diagnosa_awal">diagnosa awal :</label>
                        <input type="text" class="form-control " name="diagnosa_awal"  value="{{$iden->diagnosa_awal}}" readonly>
                    </div>
                      </div>
                    </form>
                    @endforeach
                ...
                <div class="card-body">
                    ...
                    @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <textarea type="text" class="form-control " name="anamnesis" value="{{Request::old('anamnesis')}}" required></textarea>
                        </div>
                        <div class="form-group row">
                            <label for="pemeriksaan_fisik">Pemeriksaan Fisik</label>
                            <textarea type="text" class="form-control " name="px_fisik" value="{{Request::old('px_fisik')}}" required></textarea>
                        </div>
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control "id="penunjang" name="penunjang" {{Auth::user()->profesi !== "Admin" ? 'disabled="true"': ''}}>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control " name="diagnosis" {{Auth::user()->profesi !== "Admin" ? 'readonly': ''}}>
                          </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control " name="reseplist" id="reseplist" {{Auth::user()->profesi !== "Admin" ? 'disabled="true"': ''}}>
                                <option value="" selected disabled>Pilih satu</option>
