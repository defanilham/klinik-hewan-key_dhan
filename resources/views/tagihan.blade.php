                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div>
                                ...
                                <div>Nama Hewan : {{$iden->nama_hewan}}</div>
                                <div>Usia : {{hitung_usia($iden->tgl_lhr)}}</div>
                                <div>Jenis Hewan : {{$iden->jenis_hewan}}</div>
                                <div>Ras : {{$iden->ras}}</div>
                                <div>Warna Bulu : {{$iden->warna_bulu}}</div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6 no-print">
                                    <a href="javascript:;" data-toggle="modal" onclick="print()" data-target="#DeleteModal" class="btn btn-primary btn-block">
                                        <span class="icon"><i class="fa fa-print"></i></span><span class="text"> Cetak</span>
                                    </a>
                                </div>                                      
                     </div>   
                </div>
