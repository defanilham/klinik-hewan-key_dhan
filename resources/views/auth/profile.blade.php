        ...
        <div class="col-md-4 align-items-center">
            <div class="row justify-content-center">
                ...
                <div class="profile-header-img">
                    <img width="250px" class="rounded-circle img-fluid" src="{{ asset('storage/avatars/' . Auth::user()->avatar) }}" 
                    <!-- badge -->
                    <div class="rank-label-container text-center">
                        <h4><span class="badge badge-dark">{{($user->profesi=="Dokter" ? 'drh. ':'')}}{{ ucwords($user->name)}}</span></h4>
                    </div>
                </div>
                </div>
        </div>
