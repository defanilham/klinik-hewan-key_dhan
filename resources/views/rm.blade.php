...
<!--End Modal-->
    ...
    <div class="card shadow mb-4">
                ...
                <div class="card-header d-sm-flex align-items-center justify-content-between py-3">               
                  <h6 class="m-0 font-weight-bold text-primary">Daftar Laporan Rekam Medis</h6>
                      <div class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm no-print" onclick="printRm()">
                        <span class="icon"><i class="fa  fa-print"></i></span>
                        <span class="text"> Cetak Laporan Rekam Medis</span> 
                      </div>
                    </div>
                ...
                <table class="table table-bordered table-striped" id="pasien" width="100%" cellspacing="0">
                  ...
                  @foreach ($rms as $index => $rm)
                    <tr>
                      ...
                      <td width="120px">
                        <a href="{{route('rm.lihat', $rm->idpasien)}}" class="btn btn-success btn-sm btn-icon-split">
                          <span class="icon">
...
<script type="text/javascript">
    ...
    <script>
     ...
     function printRm() {
                var popupWindow = window.open('{{ route("rm.cetakAll") }}', '_blank');
