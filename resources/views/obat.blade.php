...
<!--End Modal-->
    <div class="card shadow mb-4">
        <div class="card-header d-sm-flex align-items-center justify-content-between py-3">               
            ...
            @endunless
            <div class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm no-print" onclick="printObat()">
              <span class="icon"><i class="fa  fa-print"></i></span>
              <span class="text"> Cetak Laporan Stok Obat</span> 
            </a>
          </div>
        </div>
            <div class="card-body">
  ...
  <script type="text/javascript">
     ...
     function printObat() {
                var popupWindow = window.open('{{ route("obat.cetakAll") }}', '_blank');
