                ...
                <div class="row">
                    ...
                    <input type="hidden" name="id" value="{{ $data->id }}">
                        ...
                        <div class="form-group row col-sm-12  ">
                            ...
                            <textarea type="text" class="form-control " name="anamnesis"  required>{{ $data->anamnesis}}</textarea>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-12 mb-3 mb-sm-0">
                            <label for="pemeriksaan_fisik">Pemeriksaan Fisik</label>
                            <textarea type="text" class="form-control " name="px_fisik" required>{{ $data->pxfisik }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
