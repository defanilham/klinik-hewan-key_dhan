<head>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('pengumuman') }}">
        <div class="sidebar-brand-icon {{(get_setting('gambarbool') !== 1) ? 'rotate-n-15' :''}}">
        @if (get_setting('gambarbool') === 1)
            <img src ="{{asset('storage/logo/'. get_setting('gambar'))}}" width=50px style="border-radius: 50%;">
        @else
      ...
      <li class="nav-item {{ set_menu(['pasien', 'pasien.tambah', 'pasien.edit']) }}">
        <a class="nav-link collapsed" href="{{route('pasien')}}" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
      ...
      <li class="nav-item {{ set_menu(['lab', 'lab.tambah', 'lab.edit']) }}">
        <a class="nav-link collapsed" href="{{route('lab')}}" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <div id="collapseThree" class="collapse {{ set_show(['lab', 'lab.tambah', 'lab.edit']) }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            @unless (Auth::user()->profesi == 'Dokter')
      ...
      <li class="nav-item {{ set_menu(['obat', 'obat.tambah', 'obat.edit']) }}">
        <a class="nav-link collapsed" href="{{route('obat')}}" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true" aria-controls="collapseTwo">
      ...
      <li class="nav-item {{ set_menu(['rm', 'rm.tambah', 'rm.edit','rm.list','rm.lihat','rm.tambah.id','tagihan']) }}">
        <a class="nav-link collapsed" href="{{route('rm')}}" data-toggle="collapse" data-target="#collapseFive" aria-expanded="true" aria-controls="collapseTwo">
        ...
        <div id="collapseFive" class="collapse {{ set_show(['rm', 'rm.tambah', 'rm.edit','rm.lihat','rm.tambah.id']) }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            @unless (Auth::user()->profesi == 'Staff')
      ...
      <li class="nav-item {{ set_menu(['login', 'register', 'user','profile.edit','profile.edit.admin','profile.edit']) }}">
        <a class="nav-link collapsed" href="{{route('profile.edit')}}" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
...
<li class="nav-item dropdown no-arrow">
  <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      @if (Auth::user()->avatar)
          <img class="rounded-circle" src="{{ asset('storage/avatars/' . Auth::user()->avatar) }}" width="60" alt="User Avatar">
      @else
          <!-- Tampilkan gambar default jika tidak ada gambar profil -->
          <img class="rounded-circle" src="{{ asset('img/default-avatar.png') }}" width="60" alt="Default Avatar">
      @endif
  </a>
